...
public class UpdateEmployee extends JFrame implements ActionListener {
    ...
    JTextField tfeducation, tffname, tfaddress, tfphone, tfaadhar, tfemail, tfsalary, tfdesig;
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == add) {
             ...
             try {
                 ...
                 String query = "update employee set fname = '"+fname+"', salary = '"+salary+"', address = '"+address+"', phone = '"+phone+"', email = '"+email+"', edu = '"+edu+"', desig = '"+desig+"' where empId = '"+empId+"'";
